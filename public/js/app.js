...
function updateCart(medicine) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', medicine).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var medicine = JSON.parse(btn.dataset.medicine);
    updateCart(medicine);
  });
...
__webpack_require__(/*! F:\Full Stack websites\Pharma\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! F:\Full Stack websites\Pharma\resources\scss\app.scss */"./resources/scss/app.scss");
